...
def lsc_run_wrapper(param_chain, param_rf, param_run):
    ...
    result = chain.run(n_iter=param_run['n_iter'], RF=rf1, only_save_last_bed=param_run['only_save_last_bed'], info_per_iter=param_run['info_per_iter'],plot=param_run['plot'],progress_bar=param_run['progress_bar'])
...
if __name__=='__main__':
    ...
    largeScaleChain.crf_data_weight = np.loadtxt('data_weight_denman.txt')
    largeScaleChain.set_update_type('CRF_weight')
